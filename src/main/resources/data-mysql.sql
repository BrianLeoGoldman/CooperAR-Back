...
('Programar una aplicacion Python', 'Se necesita un desarrollador de software con experiencia en el lenguaje de programación python para colaborar en tareas de desarrollo', 380, 3,LOCALTIME, null, 'EXTREMA', 'adrian127', 'SIN TRABAJADOR', 'DISPONIBLE'),
('Reparar una puerta de madera', 'La puerta frontal de madera de ébano es muy antigua y se traba al tratar de abrirla o cerrarla', 200, 2, LOCALTIME, null, 'FACIL', 'maria_ana', 'roberto1985', 'EN_CURSO'),
('Cocinar una torta de chocolate', 'Se necesita una torta de crema y chocolate que alcance para unos 30 invitados para una fiesta de cumpleaños', 80, 4, LOCALTIME, null, 'FACIL', 'abel1945', 'SIN TRABAJADOR', 'DISPONIBLE'),
('Limpiar el hotel', 'Las habitaciones de los 5 pisos deben ser desinfectadas y quedar limpias para recibir a los huespedes', 270, 2, LOCALTIME, null, 'DIFICIL', 'maria_ana', 'SIN TRABAJADOR', 'DISPONIBLE'),
('Programar una pagina web', 'La tienda necesita una pagina web facil de usar para que los clientes puedan encargar pedidos y ver nuestro catalogo', 300, 1, LOCALTIME, null, 'REGULAR', 'roberto1985', 'SIN TRABAJADOR', 'DISPONIBLE'),
('Arreglar un par de zapatos', 'Son un par de zapatos de vestir que estan empezando a romperse en las suelas', 130, 4, LOCALTIME, null, 'REGULAR', 'abel1945', 'SIN TRABAJADOR', 'DISPONIBLE'),
('Reparar la sala de reuniones', 'Hay un agujero en el techo de la sala. Ya estan comprados todos los materiales para la obra', 2300, 5, LOCALTIME, null, 'EXTREMA', 'roberto1985', 'SIN TRABAJADOR', 'DISPONIBLE'),
('Atrapar un raton', 'Hay un raton en el sotano de mi casa. Es un lugar oscuro y con poco espacio para moverse', 50, 4, LOCALTIME, null, 'RIDICULA', 'abel1945', 'SIN TRABAJADOR', 'FINALIZADA'),
('Diseñar una campaña publicitaria', 'El producto es una campera de cuero, y la campaña debe estar orientada a la gente joven', 240, 1, LOCALTIME, null, 'DIFICIL', 'roberto1985', 'SIN TRABAJADOR', 'DISPONIBLE'),
('Atender un bar', 'Se necesita un barman con experiencia con conocimiento en preparar tragos para atender el bar', 210, 2, LOCALTIME, null, 'REGULAR', 'maria_ana', 'SIN TRABAJADOR', 'DISPONIBLE'),
('Vigilar un edificio', 'Se necesita alguien para hacer la vigilancia nocturna alrededor del edificio de unos 260 metros cuadrados', 300, 2, LOCALTIME, null, 'REGULAR', 'maria_ana', 'SIN TRABAJADOR', 'DISPONIBLE'),
